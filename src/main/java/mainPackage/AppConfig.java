...
public class AppConfig {
    ...
    public static String fromEmail = "bireports@beetlerim.com";
	   ...
	   public static String getAutoCharges = "Select ChargeCode, Amount, StartDate,EndDate,Description from automation.LeaseReneWalsAutoChargesConfiguration Where Flag =1 and Description !='PriorRentMonthly'";
