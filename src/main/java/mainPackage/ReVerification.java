...
public class ReVerification {
	...
	public static boolean verifyMoveInCharges() {
		try {
			...
			GenericMethods.logger.error("Issue in Re-Checking Move in charges");
			RunnerClass.failedReason = RunnerClass.failedReason + "," + "Issue in Re-Checking Move in charges";
			return false;
		}
	}
	public static boolean verifyAutoCharges() {
		try {
			...
			GenericMethods.logger.error("Issue in Re-Checking Auto charges");
			RunnerClass.failedReason = RunnerClass.failedReason + "," + "Issue in Re-Checking Auto charges";
			return false;
		}
		return true;
